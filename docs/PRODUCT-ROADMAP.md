...
| Wardrobe and customization | Complete, attractive outfits with enough examples to understand customization. | Wardrobe has two starting outfits on one body study and verified image export. The casual trousers now clear the shoes/socks in matched resting and moving-pose views, with foundation coverage preserved; see WARDROBE-TROUSER-FIT-2026-09-13.md. Upper-garment fit, layering, style variety and wider-body coverage still need work. |
