 ...
 */
const WALKED_SUBJECTS = [ 'renderer', 'scene', 'camera', 'drawingBufferSize', 'renderParticipants' ];
...
try {
    ...
    const reachProbes = {
        ...
        'drawingBufferSize.x': 'the resize scratch vector, read as numbers',
        'renderParticipants.clients': 'the live render-owner set, including its size',
        'renderParticipants.failedImage': 'whether cached scene output is available'
    };
